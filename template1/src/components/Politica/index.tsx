...
function Politica() {
    return (
        <div className="w3-content w3-center" style={{ maxWidth: '2000px', marginTop: '46px' }} id="contato" >
            <div id="politica" className="w3-display-container w3-center">
                <img
                    className="w3-image"
                    src={Header}
                    alt="mscalhas"
                ...
                <div className="m6 l6 w3-light-grey">
                    ...
                    <div className="l7 w3-padding w3-justify w3-content">
                        <p>A sua privacidade é importante para nós. É política do MS Calhas respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site MS Calhas, e outros sites que possuímos e operamos.
                            ...
                            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o MS Calhas oferece no site e com caráter enunciativo, mas não limitativo:
                            </p>
                            <ul>
                                <li>A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;
                                </li><li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, jogos de sorte ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;
                                </li><li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do MS Calhas, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.
                                </li>
                            </ul>
                            ...
                            <p>Esta política é efetiva a partir de 10 August 2023 22:11</p>
                            </p>
                    </div>
                </div>
            </div>
