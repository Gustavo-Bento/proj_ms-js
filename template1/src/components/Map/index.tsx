...
function Map() {
    return (
        <div className="w3-container w3-hide-small" id="endereco" >
                ...
                <div className="col-sm-8">
                    <div className="w3-container row">
                        <div className="col-sm-6">
                            <a className="w3-button w3-btn w3-padding" href="https://www.google.com/maps/dir//MS+Calhas+Hidraulica,+PQ+-+R.+Regina+Maria+de+Oliveira,+898+-+Parque+Nossa+Sra.+da+Candelaria,+Itu+-+SP,+13310-150/@-22.2037669,-54.1456241,6.04z/data=!4m9!4m8!1m0!1m5!1m1!1s0x94cf45502f583873:0x3b43cfa3c1183410!2m2!1d-47.3086023!2d-23.2723179!3e0">
                                <img src={Local} className="w3-image" style={{ width: '120%' }} />
                            </a>
                        </div>
                        <div className="col-sm-6  w3-light-grey">
