            ...
            <div className="w3-row w3-light-grey w3-margin w3-wide-small">
                ...
                <div className="w3-col m4 l4 w3-container">
                    <div className="w3-margin">
                        ...
                        <a className="w3-block w3-justify w3-button w3-block w3-light-grey w3-center" target="_blank" href="https://www.google.com/maps/dir//MS+Calhas+Hidraulica,+PQ+-+R.+Regina+Maria+de+Oliveira,+898+-+Parque+Nossa+Sra.+da+Candelaria,+Itu+-+SP,+13310-150/@-22.2037669,-54.1456241,6.04z/data=!4m9!4m8!1m0!1m5!1m1!1s0x94cf45502f583873:0x3b43cfa3c1183410!2m2!1d-47.3086023!2d-23.2723179!3e0">
                        ...
                        <div className="w3-row">
                            <div className="w3-col l6 w3-center">
                                ...
                                <a className='w3-block w3-justify w3-button w3-block w3-light-grey w3-center' href="tel:+5511999601512">(11)99960-1512</a>
                            </div>
                            <div className="w3-col l6 w3-center">
                                <h4 className="w3-wide"><b><i className="fa fa-phone" style={{ fontSize: 24 }}></i> Celular</b></h4>
                                <a className='w3-block w3-justify w3-button w3-block w3-light-grey w3-center' href="tel:+551140223638">(11) 4022-3638</a>
                            </div>
                        </div>
                    </div>
                </div>
